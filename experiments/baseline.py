...
class KernelBuilder:
    ...
    def build_kernel(
        ...
        self.emit({"valu": [("-", v_tree_diff34, v_tree_4, v_tree_3)]})
        ...
        self.emit({"valu": [("-", v_tree_diff56, v_tree_6, v_tree_5)]})
